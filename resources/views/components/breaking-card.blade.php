...
<div
    ...
    <div class="relative z-10 flex flex-col gap-4 justify-end h-full">
        ...
        <div>
            ...
            {{-- Link --}}
            <a href="{{ $link }}"
                class="inline-flex items-center text-white/90 text-lg font-bold font-['Instrument_Sans'] underline underline-offset-4 decoration-2 group-hover:text-white transition-all duration-300">
                Read more
